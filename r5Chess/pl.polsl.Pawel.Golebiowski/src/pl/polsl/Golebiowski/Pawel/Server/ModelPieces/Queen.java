...
public class Queen extends Piece {
    ...
    public Queen(Square.Color color) {
        this.color = color;
    }
    ...
    public boolean TryToMove(int positionX, int positionY, int destinationX, int destinationY) {
        ...
        int diffrenceX = absoluteValue(destinationX - positionX);
        int diffrenceY = absoluteValue(destinationY - positionY);

        if (positionX == destinationX || positionY == destinationY || diffrenceX == diffrenceY) {
            return true;
        } else {
            return false;
        }
